...
//!
//! Defines the interface that all robot tools implement.
//!
//! ## Compatibility Note
//!
//! This trait is compatible with SenAgentOS's `Tool` trait
//! (`src::tools::traits::Tool`) and can be adapted via
//! [`RobotToolAdapter`](crate::integration::RobotToolAdapter).
//!
//! # Example
//!
//! ```rust,ignore
//! use senagent_robot_kit::{Tool, ToolResult};
...
///
/// ```rust,ignore
/// use SenAgentOS_robot_kit::{Tool, ToolResult};
/// use async_trait::async_trait;
/// use serde_json::{json, Value};
///
/// pub struct BeepTool;
