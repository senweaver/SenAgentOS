...
const OTP_ISSUER: &str = "SenAgentOS";
...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(senagent_dir);
...
pub fn secret_file_path(senagent_dir: &Path) -> PathBuf {
    senagent_dir.join(OTP_SECRET_FILE)
}
