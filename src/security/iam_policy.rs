...
/// Maps a single Nevis role to SenAgentOS permissions.
...
/// IAM policy engine that maps Nevis roles to SenAgentOS tool permissions.
///
...
mod tests {
    ...
    fn test_mappings() -> Vec<RoleMapping> {
        vec![
            RoleMapping {
                ...
                senagent_permissions: vec!["all".into()],
                workspace_access: vec!["all".into()],
            },
            RoleMapping {
                nevis_role: "operator".into(),
                senagent_permissions: vec![
                    "shell".into(),
                    "file_read".into(),
                    "file_write".into(),
                    "memory_search".into(),
            ...
            RoleMapping {
                ...
                senagent_permissions: vec!["file_read".into(), "memory_search".into()],
    ...
    fn duplicate_normalized_roles_are_rejected() {
        let mappings = vec![
            ...
            RoleMapping {
                nevis_role: " ADMIN ".into(),
                senagent_permissions: vec!["file_read".into()],
