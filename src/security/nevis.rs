...
//! Nevis IAM authentication provider for SenAgentOS.
//!
...
//! roles to SenAgentOS tool permissions via [`super::iam_policy::IamPolicy`].
...
mod tests {
    ...
    fn nevis_identity_serde_roundtrip() {
        ...
        assert_eq!(parsed.user_id, "senagent_user");
