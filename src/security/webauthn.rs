...
impl WebAuthnManager {
    ...
    /// will be stored (typically `~/.senagent/`).
...
mod tests {
    ...
    fn start_registration_returns_valid_challenge() {
        ...
        assert_eq!(creation.rp.name, "SenAgentOS Test");
    ...
    fn default_config_has_sane_values() {
        ...
        assert_eq!(config.rp_name, "SenAgentOS");
    }
}
