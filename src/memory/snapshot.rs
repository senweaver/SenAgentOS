...
const SNAPSHOT_HEADER: &str = "# 🧠 SenAgentOS Memory Snapshot\n\n\
    > Auto-generated by SenAgentOS. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 SenAgentOS Memory Snapshot

> Auto-generated by SenAgentOS.
...
I am SenAgentOS, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 SenAgentOS Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
