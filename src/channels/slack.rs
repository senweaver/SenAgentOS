...
/// Extract the Slack message timestamp from a SenAgentOS message ID.
///
...
impl SlackChannel {
    ...
    fn parse_block_action_as_command(
        ...
        let command = match action_id {
            "senagent_config_provider" => format!("/models {selected_value}"),
            "senagent_config_model" => format!("/model {selected_value}"),
            _ => return None,
        };
