...
//! Plugin manifest — `~/.senagent/tools/<name>/tool.toml` schema.
//!
...
/// Execution configuration — how SenAgentOS spawns the tool.
#[derive(Debug, Deserialize)]
...
///
/// When present, SenAgentOS will prefer the named transport kind
