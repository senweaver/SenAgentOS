...
export default function Logs() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Informational banner â€?what appears here and what does not */}
      {!infoDismissed && (
        <div className="flex items-start gap-3 px-6 py-3 border-b flex-shrink-0" style={{ borderColor: 'rgba(56, 189, 248, 0.2)', background: 'rgba(56, 189, 248, 0.05)' }}>
          <div className="flex-1 text-xs" style={{ color: 'var(--pc-text-secondary)' }}>
            ...
            agent activity over SSE â€?LLM requests, tool calls, agent start/end, and errors.
            ...
            {' '}To see tracing logs, run the daemon with <code>RUST_LOG=info senagent</code> and check your terminal.
          </div>
          <button
