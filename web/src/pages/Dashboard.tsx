...
import type { StatusResponse, CostSummary, Session } from '@/types/api';
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 stagger-children">
      {channels.map((channel) => (
        <div
          ...
          style={{
            border: `1px solid ${healthBorder(channel.health ?? 'healthy')}`,
            background: healthBg(channel.health ?? 'healthy'),
          }}
          onMouseEnter={(e) => {
            e.currentTarget.style.transform = "translateY(-2px)";
            e.currentTarget.style.boxShadow = `0 4px 12px ${healthBorder(channel.health ?? 'healthy')}`;
          }}
          onMouseLeave={(e) => {
        ...
        >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span
                  className="status-dot"
                  style={{
                    background: healthColor(channel.health ?? 'healthy'),
                    boxShadow: `0 0 6px ${healthColor(channel.health ?? 'healthy')}`,
                  }}
                />
          </div>
          ...
          >
            ...
            <div className="flex justify-between text-xs">
              ...
              <span className="capitalize" style={{ color: healthColor(channel.health ?? 'healthy') }}>
